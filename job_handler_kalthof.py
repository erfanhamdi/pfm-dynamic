...
if wait:
    ...
    hold_modifier = ""
python_file = 'pfm_lite/src/main_dynamic_kalthof.py'
...
T_final = 100e-6     # total physical time (s)
v_imp   = 16.5      # imposed velocity (m/s)
T_ramp  = 1e-6      # velocity ramp-up time (s)
